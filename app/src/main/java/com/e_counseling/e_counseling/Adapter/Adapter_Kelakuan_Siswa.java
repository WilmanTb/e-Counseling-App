...
public class Adapter_Kelakuan_Siswa extends RecyclerView.Adapter<Adapter_Kelakuan_Siswa.MyViewHolder> {

    Context context;
    ArrayList<PengaduanClass> list;


    public Adapter_Kelakuan_Siswa(Context context, ArrayList<PengaduanClass> list) {
    ...
    @NonNull
    @Override
    public Adapter_Kelakuan_Siswa.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_kelakuan_siswa, parent, false);
        return new Adapter_Kelakuan_Siswa.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Kelakuan_Siswa.MyViewHolder holder, int position) {

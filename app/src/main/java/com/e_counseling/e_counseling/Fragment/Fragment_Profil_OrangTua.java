...
import com.e_counseling.e_counseling.Activity.OrangTua.Activity_Lengkapi_Data_OrangTua;
...
public class Fragment_Profil_OrangTua extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        root = (ViewGroup) inflater.inflate(R.layout.fragment_profile_orangtua,container,false);
        ...
        cvData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                animationClick(view);
                startActivity(new Intent(getActivity(), Activity_Lengkapi_Data_OrangTua.class));
            }
        });

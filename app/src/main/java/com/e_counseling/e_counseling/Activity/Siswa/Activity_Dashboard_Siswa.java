...
import com.e_counseling.e_counseling.Fragment.Fragment_Dashboard_Siswa;
import com.e_counseling.e_counseling.Fragment.Fragment_Profil_Siswa;
...
public class Activity_Dashboard_Siswa extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new Fragment_Dashboard_Siswa()).commit();
    ...
    protected void onStart() {
        ...
        if (firebaseUser == null) {
            startActivity(new Intent(Activity_Dashboard_Siswa.this, Activity_Home.class));
            finish();
        } else {
            getName();
        }
    ...
    public void onBackPressed() {
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Activity_Dashboard_Siswa.this.finish();
            super.onBackPressed();
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_profile:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new Fragment_Profil_Siswa()).commit();
                break;

            case R.id.nav_logout:
                progressDialog.show();
                mAuth.signOut();
                startActivity(new Intent(Activity_Dashboard_Siswa.this, Activity_Login.class));
                finish();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.cvLaporanKelakuan:
                getAnimationClick(view);
               /* if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_Dashboard_Siswa.this, Activity_Kelakuan_Siswa.class));
               /* }else{
                    setDialog();
                }*/
                break;
            ...
            case R.id.cvJadwalKonseling:
                getAnimationClick(view);
                /*if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_Dashboard_Siswa.this, Activity_JadwalKonseling_Siswa.class));
                /*}else{
                    setDialog();
                }*/
                break;

            case R.id.cvPengaduan:
                getAnimationClick(view);
               /* if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_Dashboard_Siswa.this, Activity_Pengaduan_Siswa.class));
               /* }else{
                    setDialog();
                }*/
                break;
        ...
        dbUser.child(Uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    drawer = findViewById(R.id.drawer_layout);
                    NavigationView navigationView = findViewById(R.id.nav_view);
                    navigationView.setNavigationItemSelectedListener(Activity_Dashboard_Siswa.this);
                    View headerView = navigationView.getHeaderView(0);
                    ...
                    Toast.makeText(Activity_Dashboard_Siswa.this, "Snapshot tidak ada", Toast.LENGTH_SHORT).show();
                }
            }

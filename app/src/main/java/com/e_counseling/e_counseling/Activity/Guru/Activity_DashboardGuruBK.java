...
import com.e_counseling.e_counseling.Fragment.HomeFragment;
...
public class Activity_DashboardGuruBK extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_logout:
                progressDialog.show();
                mAuth.signOut();
                startActivity(new Intent(Activity_DashboardGuruBK.this, Activity_Login.class));
                finish();
        ...
        switch (view.getId()) {
            case R.id.cvPengaduan:
                ...
                /*if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_DashboardGuruBK.this, Activity_Pengaduan.class));
               /* }else{
                    setDialog();
                }*/
                break;

            case R.id.cvLaporanPelanggaran:
                getAnimationClick(view);
                /*if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_DashboardGuruBK.this, Activity_LaporanPelanggaran.class));
                /*}else{
                    setDialog();
                }*/
                break;

            case R.id.cvDataPerilakuSiswa:
                getAnimationClick(view);
                /*if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_DashboardGuruBK.this, Activity_DataPerilakuSiswa.class));
                /*}else{
                    setDialog();
                }*/
                break;
            ...
            case R.id.cvJadwalKonseling:
                getAnimationClick(view);
                /*if (mAuth.getCurrentUser().isEmailVerified()) {*/
                    startActivity(new Intent(Activity_DashboardGuruBK.this, Activity_JadwalKonseling.class));
                /*}else {
                    setDialog();
                }*/
                break;
            ...
            /*case R.id.cvLaporan:
                getAnimationClick(view);
                startActivity(new Intent(Activity_DashboardGuruBK.this, Activity_Laporan.class));
                break;*/
        }
    }
        ...
        dbUser.child(Uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    drawer = findViewById(R.id.drawer_layout);
                    NavigationView navigationView = findViewById(R.id.nav_view);
                    navigationView.setNavigationItemSelectedListener(Activity_DashboardGuruBK.this);
                    View headerView = navigationView.getHeaderView(0);
                    ...
                    Toast.makeText(Activity_DashboardGuruBK.this, "Snapshot tidak ada", Toast.LENGTH_SHORT).show();
                }
            }
